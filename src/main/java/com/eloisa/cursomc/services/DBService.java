...
import com.eloisa.cursomc.domain.Pagamento;
import com.eloisa.cursomc.domain.PagamentoComBoleto;
import com.eloisa.cursomc.domain.PagamentoComCartao;
...
import com.eloisa.cursomc.repositories.CidadeRepository;
...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "eloisa.oliveirasantos@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "anacosta@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2020 16:30"),cli1,e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2020 16:30"),cli1,e2);
